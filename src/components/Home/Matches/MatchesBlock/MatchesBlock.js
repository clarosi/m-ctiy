            ...
            <div className="match_wrapper">
                <div className="match_top">
                    <div className="left">
                        <div 
                            className="icon"
                            style={{background: `url(/images/team_icons/${props.match.localThmb}.png)`}}
                        >
                        </div>
                ...
                {/* TODO: refactor implement DRY principle */}
                <div className="match_bottom">
                    <div className="left">
                        <div 
                            className="icon"
                            style={{background: `url(/images/team_icons/${props.match.awayThmb}.png)`}}
                        >
                        </div>
